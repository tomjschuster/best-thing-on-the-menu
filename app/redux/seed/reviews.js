export default [
		{ id: 1, stars: 4, itemId: 1, userId: 61, comment: 'Forever favorite burger for New Yorker!' },
		{ id: 2, stars: 2, itemId: 1, userId: 64, comment: 'Almost every time I go, they get my order wrong; probably because the waiter is walking away before I even finish explaining what I want.'  },
		{ id: 3, stars: 3, itemId: 1, userId: 2, comment: 'I ordered the burger it was bland. The fries were all right. I ordered the frozen hot chocolate, it was magnificent.  It is the only reason I have a three star review. '},
		{ id: 4, stars: 5, itemId: 5, userId: 2, comment: 'So I\'m going to start off with saying this is one of my favorite places to eat. Their Orange Chicken and Tom Yum soup is my lunch special about 3 times a week. ' },
		{ id: 5, stars: 4, itemId: 5, userId: 7, comment: 'Overall, the food has decent flavors, is served in large portions, and the ambiance is decent' },
